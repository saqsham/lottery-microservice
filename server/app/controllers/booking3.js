const Booking = require('../models').Booking3
...
module.exports = {
    ...
    async createBet(req, res) {
        await Booking
            .checkBet(req.params.userId, req.body.sixDigit)
            .then(async user => {
                if (!user) {
                    return res.status(404).send({
                ...
                await user
                    ...
                    .then(async () => {
                        await MoneyChart
                            .transactionBet(req.params.userId, req.body.betValue, req.body.sixDigit)
                            .then(async () => {
                                await BetHistory
                                    .create({
                                        betValue: req.body.betValue,
                                        betted_on: req.body.sixDigit,
                                        userId: req.params.userId,
                                        birth: dateNow,
                                    })
                            })
    ...
    async calculateScoresAndTransfer(req, res) {
        await BookingChart
            ...
            .then(booking => {
                ...
                mul = booking.mul_for_game3
                winNumThis = booking.pre_winNum_game3
            })
            .catch(error => res.status(400).send(error));
